...
<head>
    ...
    <title>Imma app | Examens fais</title>
...
<section>
        <div class="bloc_menu">
            ...
            <a href="#" class="exception">Dashboard Medecin</a>
                ...
                <a href="{{ route('medecin.examen-fait') }}" class="normal" style="color:rgb(58, 107, 243);">Liste examens faits</a>
        ...
        <div class="bloc_infos">
            ...
            <div class="container mt-5">
                ...
                @endif
                <h2 class="text-left" id="title">Liste examens faits</h2>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('medecin.prescription', $examen['patient_id']) }}" class="btn btn-success btn-sm">Prescrire</a>
            </td>
        </tr>
        @endforeach
    </tbody>
